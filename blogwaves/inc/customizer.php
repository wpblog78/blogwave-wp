...
function blogwaves_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting ( 'blogwaves_copyright', array (
		'default'           => __( 'Copyright © 2020 Powered by WordPress', 'blogwaves' ),
...
function blogwaves_customize_preview_js() {
	wp_enqueue_script( 'blogwaves-customizer', get_template_directory_uri() . '/assets/js/customizer.js', array( 'customize-preview' ), _S_VERSION, true );
}
